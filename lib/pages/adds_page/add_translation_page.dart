...
class AddTranslationPage extends StatefulWidget {
  const AddTranslationPage({super.key, required this.movieModel});
  final MovieModel? movieModel;

  @override
  State<AddTranslationPage> createState() => _AddTranslationPageState();
}

class _AddTranslationPageState extends State<AddTranslationPage> {
